        ...
        <div className="p-4 sm:p-6 space-y-5 overflow-y-auto flex-1">
          ...
          {showAddForm && (
            <form 
              ...
              className="p-4 sm:p-5 rounded-xl bg-slate-900/95 border border-[#00FFB4]/30 space-y-4 shadow-xl animate-fadeIn"
            >
              ...
              <div className="flex items-center justify-end gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#00FFB4] text-black font-bold text-xs tracking-wider uppercase hover:brightness-110 active:scale-95 transition-all shadow-[0_0_15px_rgba(0,255,180,0.3)] disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
